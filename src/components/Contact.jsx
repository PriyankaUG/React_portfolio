    ...
    <section id="contact" className="py-16 sm:py-20 px-4 sm:px-6 relative">
      <div className="max-w-7xl mx-auto">
        <motion.h2
          ...
          className="text-3xl sm:text-4xl md:text-5xl font-bold mb-12 sm:mb-16 text-center text-blue-300"
        >
          Get In Touch
        </motion.h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="bg-slate-900 rounded-xl p-5 sm:p-8 border border-slate-800"
          >
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-4">
                <a
                  href="https://github.com/PriyankaUG"
                  target="_blank"
          ...
          >
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-500 transition-colors"
              >
                Send Message
              </button>
            </form>
